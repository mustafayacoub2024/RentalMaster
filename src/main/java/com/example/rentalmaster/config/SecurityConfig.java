    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/employees/**").hasRole("DIRECTOR")
                        .requestMatchers(HttpMethod.PUT, "/employees/**").hasRole("DIRECTOR")
                        .requestMatchers(HttpMethod.DELETE, "/employees/**").hasRole("DIRECTOR")
                        .requestMatchers(HttpMethod.GET, "/employees/**").hasRole("DIRECTOR")
                        .requestMatchers(HttpMethod.GET, "/api/test-report").hasRole("DIRECTOR")
